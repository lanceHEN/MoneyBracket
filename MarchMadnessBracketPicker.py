...
def pythag(AdjO, AdjD):
    ...
    EW = (AdjO**13.91) / ((AdjO**13.91) + (AdjD**13.91))
...
#63 teams in each tournament
roundteams = []
winnings = []
for i in range(0, sims):
    
    #update the below line once the actual bracket is released
    teams = ["Kansas 1", "Southeast Missouri St. 16", "Missouri 8", "Memphis 9", "Miami FL 5", "Bradley 12", "Indiana 4", "Hofstra 13", "San Diego St. 6", "Mississippi St. 11", "Marquette 3", "Colgate 14", "Northwestern 7", "USC 10", "Arizona 2", "Eastern Washington 15", "UCLA 1", "Texas A&M Corpus Chris 16", "Providence 8", "Boise St. 9", "TCU 5", "Iona 12", "Xavier 4", "Utah Valley 13", "Michigan St. 6", "Auburn 11", "Gonzaga 3", "Furman 14", "Texas A&M 7", "N.C. State 10", "Baylor 2", "Kennesaw St. 15", "Alabama 1", "UNC Asheville 16", "Maryland 8", "Florida Atlantic 9", "Iowa St. 5", "VCU 12", "Virginia 4", "Toledo 13", "Creighton 6", "Nevada 11", "Kansas St. 3", "UC Irvine 14", "Kentucky 7", "West Virginia 10", "Purdue 2", "Vermont 15", "Houston 1", "Alcorn St. 16", "Illinois 8", "Arkansas 9", "Saint Mary's 5", "Oral Roberts 12", "Connecticut 4", "Yale 13", "Duke 6", "Rutgers 11", "Tennessee 3", "Louisiana 14", "Iowa 7", "Pittsburgh 10", "Texas 2", "Youngstown St. 15"]
